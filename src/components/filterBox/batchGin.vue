<template>
    <div class="batch-statement">
      <template>
        <el-dialog title="条件查询" :visible.sync="dialogFromStatement1" :before-close="dialog_close" :modal-append-to-body="false">
          <el-form >
            ...
            <el-form-item label="单据状态" :label-width="formLabelWidth">
              <el-select size="mini" v-model="invoiceVal" placeholder="请选择单据状态">
            ...
            <el-form-item label="对账状态" :label-width="formLabelWidth">
              <el-select size="mini" v-model="ReconVal" placeholder="请选择对账状态">
                <el-option label="全部" value=""></el-option>
            ...
            <el-form-item label="是否差异处理" :label-width="formLabelWidth">
              <el-select size="mini" v-model="differenceVal" placeholder="请选择是否差异处理">
                <el-option label="全部" value=""></el-option>
            ...
            <el-form-item label="退款状态" :label-width="formLabelWidth">
              <el-select size="mini" v-model="RefundVal" placeholder="请选择退款状态">
                <el-option label="全部" value=""></el-option>
            ...
            <el-form-item label="来源平台" :label-width="formLabelWidth">
              <el-input size="mini" v-model="Source" placeholder="请输入内容"></el-input>
            </el-form-item>
            <el-form-item label="销售公司" :label-width="formLabelWidth">
              <el-input size="mini" v-model="salesCompany" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-form>
...
<script>
  ...
  import {orderReports,balanceSheetAjax} from '../../axios/api.js'
    ...
    export default {
      ...
      computed:{
        ...mapState({
          dialogFromStatement1:state=>state.dialogFromStatement1
        })
      },
      methods: {
        // ...mapActions(["orderReportsData", "getLocalData"]),//简写
        cancel(){ //取消
          this.$store.dispatch('dialogFromStatement1')
        },
        getLocalData(){
